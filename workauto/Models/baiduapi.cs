namespace baiduAPI
{
    ...
    public class GPSChange
    {
        ...
        public static GPSPoint Gps84_To_bd09(double wgLat, double wgLon)
        {
            GPSPoint gcj02 = WGS84_to_GCJ02(wgLat, wgLon);
            GPSPoint bd09 = GCJ02_to_BD09(gcj02.GetLat(), gcj02.GetLng());
            return bd09;
